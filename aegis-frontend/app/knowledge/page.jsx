...
export default function Knowledge() {
  const health = useApi('http://localhost:8003/health', 5000)
  const stats  = useApi('http://localhost:8003/universe/stats', 10000)
  return (
    <div>
      <Nav />
      <div style={{ padding:'32px 24px' }}>
        <h1 style={{ color:'#00d4ff', marginBottom:4 }}>🧠 Knowledge Universe</h1>
        <p style={{ color:'#64748b', marginBottom:24 }}>MEGA-LAYER-3 · Port 8003</p>
