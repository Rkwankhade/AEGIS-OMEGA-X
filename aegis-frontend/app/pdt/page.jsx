...
export default function PDT() {
  const health = useApi('http://localhost:8001/health', 5000)
  const stats  = useApi('http://localhost:8001/digital-twin/stats', 10000)
  return (
    <div>
      <Nav />
      <div style={{ padding:'32px 24px' }}>
        <h1 style={{ color:'#00d4ff', marginBottom:4 }}>🌍 Planetary Digital Twin</h1>
        <p style={{ color:'#64748b', marginBottom:24 }}>MEGA-LAYER-1 · Port 8001</p>
